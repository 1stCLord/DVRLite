...
int RuleEngineBindingProxy::send_GetSupportedRules(const char *soap_endpoint_url, const char *soap_action, _tan__GetSupportedRules *tan__GetSupportedRules)
{
...
int RuleEngineBindingProxy::recv_GetSupportedRules(_tan__GetSupportedRulesResponse &tan__GetSupportedRulesResponse)
{
...
int RuleEngineBindingProxy::send_CreateRules(const char *soap_endpoint_url, const char *soap_action, _tan__CreateRules *tan__CreateRules)
{
...
int RuleEngineBindingProxy::recv_CreateRules(_tan__CreateRulesResponse &tan__CreateRulesResponse)
{
...
int RuleEngineBindingProxy::send_DeleteRules(const char *soap_endpoint_url, const char *soap_action, _tan__DeleteRules *tan__DeleteRules)
{
...
int RuleEngineBindingProxy::recv_DeleteRules(_tan__DeleteRulesResponse &tan__DeleteRulesResponse)
{
...
int RuleEngineBindingProxy::send_GetRules(const char *soap_endpoint_url, const char *soap_action, _tan__GetRules *tan__GetRules)
{
...
int RuleEngineBindingProxy::recv_GetRules(_tan__GetRulesResponse &tan__GetRulesResponse)
{
...
int RuleEngineBindingProxy::send_GetRuleOptions(const char *soap_endpoint_url, const char *soap_action, _tan__GetRuleOptions *tan__GetRuleOptions)
{
...
int RuleEngineBindingProxy::recv_GetRuleOptions(_tan__GetRuleOptionsResponse &tan__GetRuleOptionsResponse)
{
...
int RuleEngineBindingProxy::send_ModifyRules(const char *soap_endpoint_url, const char *soap_action, _tan__ModifyRules *tan__ModifyRules)
{
...
int RuleEngineBindingProxy::recv_ModifyRules(_tan__ModifyRulesResponse &tan__ModifyRulesResponse)
{
...
int RuleEngineBindingProxy::send_GetServiceCapabilities(const char *soap_endpoint_url, const char *soap_action, _tan__GetServiceCapabilities *tan__GetServiceCapabilities)
{
...
int RuleEngineBindingProxy::recv_GetServiceCapabilities(_tan__GetServiceCapabilitiesResponse &tan__GetServiceCapabilitiesResponse)
{
...
int RuleEngineBindingProxy::send_GetSupportedAnalyticsModules(const char *soap_endpoint_url, const char *soap_action, _tan__GetSupportedAnalyticsModules *tan__GetSupportedAnalyticsModules)
{
...
int RuleEngineBindingProxy::recv_GetSupportedAnalyticsModules(_tan__GetSupportedAnalyticsModulesResponse &tan__GetSupportedAnalyticsModulesResponse)
{
...
int RuleEngineBindingProxy::send_CreateAnalyticsModules(const char *soap_endpoint_url, const char *soap_action, _tan__CreateAnalyticsModules *tan__CreateAnalyticsModules)
{
...
int RuleEngineBindingProxy::recv_CreateAnalyticsModules(_tan__CreateAnalyticsModulesResponse &tan__CreateAnalyticsModulesResponse)
{
...
int RuleEngineBindingProxy::send_DeleteAnalyticsModules(const char *soap_endpoint_url, const char *soap_action, _tan__DeleteAnalyticsModules *tan__DeleteAnalyticsModules)
{
...
int RuleEngineBindingProxy::recv_DeleteAnalyticsModules(_tan__DeleteAnalyticsModulesResponse &tan__DeleteAnalyticsModulesResponse)
{
...
int RuleEngineBindingProxy::send_GetAnalyticsModules(const char *soap_endpoint_url, const char *soap_action, _tan__GetAnalyticsModules *tan__GetAnalyticsModules)
{
...
int RuleEngineBindingProxy::recv_GetAnalyticsModules(_tan__GetAnalyticsModulesResponse &tan__GetAnalyticsModulesResponse)
{
...
int RuleEngineBindingProxy::send_GetAnalyticsModuleOptions(const char *soap_endpoint_url, const char *soap_action, _tan__GetAnalyticsModuleOptions *tan__GetAnalyticsModuleOptions)
{
...
int RuleEngineBindingProxy::recv_GetAnalyticsModuleOptions(_tan__GetAnalyticsModuleOptionsResponse &tan__GetAnalyticsModuleOptionsResponse)
{
...
int RuleEngineBindingProxy::send_ModifyAnalyticsModules(const char *soap_endpoint_url, const char *soap_action, _tan__ModifyAnalyticsModules *tan__ModifyAnalyticsModules)
{
...
int RuleEngineBindingProxy::recv_ModifyAnalyticsModules(_tan__ModifyAnalyticsModulesResponse &tan__ModifyAnalyticsModulesResponse)
{
...
int RuleEngineBindingProxy::send_GetSupportedMetadata(const char *soap_endpoint_url, const char *soap_action, _tan__GetSupportedMetadata *tan__GetSupportedMetadata)
{
...
int RuleEngineBindingProxy::recv_GetSupportedMetadata(_tan__GetSupportedMetadataResponse &tan__GetSupportedMetadataResponse)
{
